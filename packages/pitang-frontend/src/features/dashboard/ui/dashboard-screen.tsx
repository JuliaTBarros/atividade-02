            ...
            <section aria-label="Key metrics" className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
                ...
                <Card role="article" aria-label="Average product price">
                    <CardHeader className="pb-2">
                        ...
                        <CardTitle
                            className="text-2xl tabular-nums">{currencyFormatter.format(metrics.averagePrice)}</CardTitle>
                    </CardHeader>
                </Card>
                            ...
                            <div className="h-72 w-full">
                                <ResponsiveContainer width="100%" height="100%">
                                    <BarChart data={stockByBrandWithColors}
                                        ...
                                        />
                                        <Bar dataKey="stock" radius={[6, 6, 0, 0]} fill="var(--chart-1)"
                                             stroke="var(--card)" strokeWidth={1}>
                                            {stockByBrandWithColors.map((entry) => (
                                                <Cell key={entry.brand} fill={entry.color} stroke="var(--card)"
                                                      strokeWidth={1}/>
                                            ))}
                                        </Bar>
                                    </BarChart>
                ...
                <Card>
                    ...
                    <CardContent>
                        <figure aria-labelledby="products-by-category-title"
                                aria-describedby="products-by-category-summary">
                            <div className="h-72 w-full">
                                <ResponsiveContainer width="100%" height="100%">
                                    <PieChart>
                                        <Pie
                                ...
                                <TableBody>
                                    {recentProducts.map((product) => (
                                        <TableRow key={product.id} className="hover:bg-muted/60">
                                            ...
                                            <TableCell
                                                className="text-right tabular-nums">{currencyFormatter.format(product.price)}</TableCell>
