                        ...
                        <div className="space-y-3 px-4 pb-4">
                            ...
                            {selectedProductId !== null && (
                                <Button variant="outline" size="sm"
                                        onClick={() => void handleViewDetails(selectedProductId)}>
                                    Retry
                                </Button>
                            )}
                        </div>
                    ...
                    {!detailLoading && !detailError && selectedProduct && (
                        <div className="space-y-4 px-4 pb-4">
                            ...
                            <div className="grid grid-cols-1 gap-2 text-sm sm:grid-cols-2">
                                ...
                                <p>
                                    <span
                                        className="font-semibold">Discount:</span> {selectedProduct.discountPercentage}%
                                </p>
                                <p>
                                ...
                                <p className="sm:col-span-2">
                                    <span
                                        className="font-semibold">Dimensions:</span> {selectedProduct.dimensions.width} x{" "}
                                    {selectedProduct.dimensions.height} x {selectedProduct.dimensions.depth}
                                </p>
                                <p className="sm:col-span-2">
                                    <span
                                        className="font-semibold">Warranty:</span> {selectedProduct.warrantyInformation}
                                </p>
                                <p className="sm:col-span-2">
                                    <span
                                        className="font-semibold">Shipping:</span> {selectedProduct.shippingInformation}
                                </p>
                                <p className="sm:col-span-2">
