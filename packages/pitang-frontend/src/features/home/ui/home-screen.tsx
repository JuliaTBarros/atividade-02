    ...
    <div className="min-h-screen overflow-hidden bg-background text-foreground">
      <section className="relative mx-auto max-w-7xl px-4 py-20 md:py-32 lg:py-40">
        ...
        <div className="space-y-6 text-center md:space-y-8">
          <div className="inline-flex items-center gap-2 rounded-full border border-accent/60 bg-accent px-4 py-2 text-sm font-semibold text-accent-foreground shadow-sm">
      ...
      <section className="mx-auto max-w-4xl px-4 py-20">
        <div className="relative overflow-hidden rounded-2xl border border-primary/35 bg-primary/15">
          <div className="relative space-y-6 p-8 text-center md:p-12">
            ...
            <div className="flex flex-col justify-center gap-4 pt-4 sm:flex-row">
              <Link to="/dashboard">
                <Button size="lg" className="bg-primary px-8 font-semibold text-primary-foreground hover:bg-primary/90">
                  Ir para Dashboard
                </Button>
              </Link>
              <Link to="/login">
      ...
      <footer className="mt-20 border-t border-border px-4 py-12">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between text-sm text-muted-foreground md:flex-row">
